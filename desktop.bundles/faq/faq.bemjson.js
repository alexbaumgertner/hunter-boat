                                    ...
                                    content: [
                                        {
                                            ...
                                            content: [
                                                {
                                                    elem: 'header',
                                                    mix: [{ block: 'patternizer', js: { 'data-pattern': 'img/headers/FAQ.jpg' } }],
                                                    ...
                                                    content: [
                                                        {
                                                            ...
                                                            content: [
                                                                ...
                                                                {
                                                                    elem: 'answer',
                                                                    content: 'Компания "Бот-Трэйдинг" в производстве надувных лодок Хантер использует немецкую лодочную ткань компании HEYTEX одного из мировых лидеров в производстве ПВХ тканей. Плотность ткани  составляет 750 гр/м. Компания "Бот-Трэйдинг" в производстве надувных лодок Хантер использует немецкую лодочную ткань компании HEYTEX одного из мировых лидеров в производстве ПВХ тканей. Плотность ткани  составляет 750 гр/м.'
                                                                }
                                                            ]
                                                        }
                                                    ...
                                                    content: [
                                                        {
                                                            ...
                                                            content: [
                                                                ...
                                                                {
                                                                    elem: 'answer',
                                                                    content: 'Компания "Бот-Трэйдинг" в производстве надувных лодок Хантер использует немецкую лодочную ткань компании HEYTEX одного из мировых лидеров в производстве ПВХ тканей. Плотность ткани  составляет 750 гр/м. Компания "Бот-Трэйдинг" в производстве надувных лодок Хантер использует немецкую лодочную ткань компании HEYTEX одного из мировых лидеров в производстве ПВХ тканей. Плотность ткани  составляет 750 гр/м. Компания "Бот-Трэйдинг" в производстве надувных лодок Хантер использует немецкую лодочную ткань компании HEYTEX одного из мировых лидеров в производстве ПВХ тканей. Плотность ткани  составляет 750 гр/м.'
                                                                }
                                                            ]
                                                        }
